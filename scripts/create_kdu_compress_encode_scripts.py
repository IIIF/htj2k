...
if( args.encoding_parameter_set ) :
  encoding_parameter_set = args.encoding_parameter_set
...
for codeblock_parameter in codeblock_parameters:
  ...
  for source_file in list_of_source_files:
    ...
    if source_file.endswith(input_file_extension):
      ...
      kdu_compress_command = path_to_kdu_compress_executable_default + " -i " + input_filename + " -o " + output_filename + " " + kdu_compress_complete_parameters_without_i_and_o
