...
LOCUST_IMG_DATASET=j2k1_lossy LOCUST_IMG_FORMAT=jp2 locust --headless -t 10m -u 1 --csv jp2_lossless --print-stats -f $LOCUSTFILE -H $EP

LOCUST_IMG_DATASET=j2k1_lossless LOCUST_IMG_FORMAT=jp2 locust --headless -t 10m -u 1 --csv jp2_lossy --print-stats -f $LOCUSTFILE -H $EP
