...
for run in runs:
    ...
    print (data)
    titles = ['ptiff-lossless-round1', 'ptiff-lossy-round1', 'htj2k-bodelian-lossless', 'j2k_bodelian_lossless', 'htj2k_bodelian_lossy', 'j2k1_bodelian_lossy','htj2k_lossless',  'htj2k-lossless-round1',  'jp2-lossless-round1', 'htj2k_lossless_plt','j2k1_lossless_plt', 'htj2k_lossy_3bpp_plt','j2k1_lossy_3bpp_plt', 'htj2k-lossy-round1', 'htj2k_lossy_Qfactor_90_plt', 'jp2-lossy-round1'] #data.keys()
    values = []
    colours = []
    for key in titles:
