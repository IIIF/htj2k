...
parser.add_argument('--source_directory',
                      help="directory where the input TIF files are located. default is --source_directory \"%s\"" % (source_directory_default) ) 
parser.add_argument("--compressed_directory", 
                      help="directory where output files will be written. default is --compressed_directory \"%s\"" % (compressed_directory_default) )
...
parser.add_argument('--output_script_filename_prefix',
                      help="filename prefix of output script containing calls to kdu_compress. default is --output_script_filename_prefix \"%s\"" % output_script_filename_prefix_default )
parser.add_argument('--path_to_kdu_compress_executable',
                      help="path to kdu_compress executable. default is --path_to_kdu_compress_executable \"%s\"" % (path_to_kdu_compress_executable_default) ) 
parser.add_argument('--compressed_file_extension',
                      help="compressed file extension. should be .jp2 or .jph, the default value is set by the encoding_parameter_set value and can be overridden by the provided with --compressed_file_extension" )
...
if( args.source_directory ) :
  ...
  print("processed --source_directory ", source_directory )
else:
  source_directory = source_directory_default
  print("--source_directory command line argument not provided, using default = ", source_directory )
...
if( args.compressed_directory ) :
  ...
  compressed_directory = compressed_directory_default
...
if( args.output_script_filename_prefix ) :
  output_script_filename_prefix = args.output_script_filename_prefix
  print("processed --output_script_filename_prefix ", output_script_filename_prefix )
else:
  output_script_filename_prefix = output_script_filename_prefix_default
  print("--output_script_filename_prefix command line argument not provided, using default = ", output_script_filename_prefix )

if( args.path_to_kdu_compress_executable ) :
  path_to_kdu_compress_executable = args.path_to_kdu_compress_executable
  print("processed --path_to_kdu_compress_executable ", path_to_kdu_compress_executable )
else:
  path_to_kdu_compress_executable = path_to_kdu_compress_executable_default
  print("--path_to_kdu_compress_executable command line argument not provided, using default = ", path_to_kdu_compress_executable )


if( args.encoding_parameter_set ) :
  encoding_parameter_set = int(args.encoding_parameter_set)
  print("processed --encoding_parameter_set ", encoding_parameter_set )
else:
  encoding_parameter_set = encoding_parameter_set_default
  print("--encoding_parameter_set command line argument not provided, using default = ", encoding_parameter_set )

if( args.smallest_thumbnail_dimension ) :
  smallest_thumbnail_dimension = int(args.smallest_thumbnail_dimension)
  print("processed --smallest_thumbnail_dimension ", smallest_thumbnail_dimension )
else:
  smallest_thumbnail_dimension = smallest_thumbnail_dimension_default
  print("--smallest_thumbnail_dimension command line argument not provided, using default = ", smallest_thumbnail_dimension )
...
for codeblock_parameter in codeblock_parameters:
  ...
  if encoding_parameter_set == 0:
    ...
    compressed_file_extension_default=".jp2"
  ...
  output_script_filename = output_script_filename_prefix_default + "_" + test_label + ".sh"
